...
- PR: #1900 (auto-merge enabled)

### Что легло
- `specs/scratch/w898_bench_module_615x2p6_aos_var_call_write.t27` (`[615][2]^6 Pt`, 39,360 elements, 1,259,520-bit packed vector, ~1.202 MiBit): module-scope non-power-of-two outer-dimension array-of-struct variable initialized from a function call, with indexed signed field writes and `assert_eq` read-back in a `bench` block.
- Generator `scripts/gen_w898.py` copied from `gen_w897.py`, copy-hazard checklist cleared (`OUTER = 615`, `MID_IDX = 307`).
- Integration test `accepts_w898_bench_module_615x2p6_aos_var_call_write` added to `bootstrap/tests/icarus_lowerable.rs`.
- Fresh seal `.trinity/seals/scratch_w898_bench_module_615x2p6_aos_var_call_write.json` (`seal --verify` MATCH).
...
- Targeted `cargo test --release --test icarus_lowerable accepts_w898_bench_module_615x2p6_aos_var_call_write` → PASS
- Full suite: 357 passed; 1 pre-existing `corpus_classifier_matches_lean_completeness` mismatch for `specs/cloud/railway_deploy.t27` tracked separately.

### Next
- Create W899 issue and branch once W898 lands.
- Variant A: `[617][2]^6 Pt` (~1.206 MiBit).

---

## feat(igla): Wave Loop 897 close-out — [613][2]^6 Pt packed AoS witness (Refs #1857)

- Branch: `wave-loop-897`
- PR: #1858 (auto-merge enabled)

### Что легло
- `specs/scratch/w897_bench_module_613x2p6_aos_var_call_write.t27` (`[613][2]^6 Pt`, 39,232 elements, 1,255,424-bit packed vector, ~1.198 MiBit): module-scope non-power-of-two outer-dimension array-of-struct variable initialized from a function call, with indexed signed field writes and `assert_eq` read-back in a `bench` block.
- Generator `scripts/gen_w897.py` copied from `gen_w896.py`, copy-hazard checklist cleared (`OUTER = 613`, `MID_IDX = 306`).
- Integration test `accepts_w897_bench_module_613x2p6_aos_var_call_write` added to `bootstrap/tests/icarus_lowerable.rs`.
- Fresh seal `.trinity/seals/scratch_w897_bench_module_613x2p6_aos_var_call_write.json` (`seal --verify` MATCH).
- Zero compiler / reference-model / `FROZEN_HASH` changes.
...
- `t27c icarus-cocotb` → reference-model OK
- `t27c seal --save` → saved
- Targeted `cargo test --release --test icarus_lowerable accepts_w897_bench_module_613x2p6_aos_var_call_write` → PASS
- Full suite: 356 passed; 1 pre-existing `corpus_classifier_matches_lean_completeness` mismatch for `specs/cloud/railway_deploy.t27` tracked separately.

### Next
- Create W898 issue and branch once W897 lands.
- Variant A: `[615][2]^6 Pt` (~1.202 MiBit).

---

## feat(igla): Wave Loop 896 close-out — [611][2]^6 Pt packed AoS witness (Refs #1855)

- Branch: `wave-loop-896`
- PR: #1856 (auto-merge enabled)

### Что легло
- `specs/scratch/w896_bench_module_611x2p6_aos_var_call_write.t27` (`[611][2]^6 Pt`, 39,104 elements, 1,251,328-bit packed vector, ~1.194 MiBit): module-scope non-power-of-two outer-dimension array-of-struct variable initialized from a function call, with indexed signed field writes and `assert_eq` read-back in a `bench` block.
- Generator `scripts/gen_w896.py` copied from `gen_w895.py`, copy-hazard checklist cleared (`OUTER = 611`, `MID_IDX = 305`).
- Integration test `accepts_w896_bench_module_611x2p6_aos_var_call_write` added to `bootstrap/tests/icarus_lowerable.rs`.
- Fresh seal `.trinity/seals/scratch_w896_bench_module_611x2p6_aos_var_call_write.json` (`seal --verify` MATCH).
- Zero compiler / reference-model / `FROZEN_HASH` changes.
...
- `t27c icarus-cocotb` → reference-model OK
- `t27c seal --save` → saved
- Targeted `cargo test --release --test icarus_lowerable accepts_w896_bench_module_611x2p6_aos_var_call_write` → PASS
- Full suite: 355 passed; 1 pre-existing `corpus_classifier_matches_lean_completeness` mismatch for `specs/cloud/railway_deploy.t27` tracked separately.

### Next
- Create W897 issue and branch once W896 lands.
- Variant A: `[613][2]^6 Pt` (~1.198 MiBit).

---

## feat(igla): Wave Loop 895 close-out — [609][2]^6 Pt packed AoS witness (Refs #1853)

- Branch: `wave-loop-895`
- PR: #1854 (auto-merge enabled)

### Что легло
- `specs/scratch/w895_bench_module_609x2p6_aos_var_call_write.t27` (`[609][2]^6 Pt`, 38,976 elements, 1,247,232-bit packed vector, ~1.190 MiBit): module-scope non-power-of-two outer-dimension array-of-struct variable initialized from a function call, with indexed signed field writes and `assert_eq` read-back in a `bench` block.
- Generator `scripts/gen_w895.py` copied from `gen_w894.py`, copy-hazard checklist cleared (`OUTER = 609`, `MID_IDX = 304`).
- Integration test `accepts_w895_bench_module_609x2p6_aos_var_call_write` added to `bootstrap/tests/icarus_lowerable.rs`.
- Fresh seal `.trinity/seals/scratch_w895_bench_module_609x2p6_aos_var_call_write.json` (`seal --verify` MATCH).
- Zero compiler / reference-model / `FROZEN_HASH` changes.
...
- `t27c icarus-cocotb` → reference-model OK
- `t27c seal --save` → saved
- Targeted `cargo test --release --test icarus_lowerable accepts_w895_bench_module_609x2p6_aos_var_call_write` → PASS
- Full suite: 354 passed; 1 pre-existing `corpus_classifier_matches_lean_completeness` mismatch for `specs/cloud/railway_deploy.t27` tracked separately.

### Next
- Create W896 issue and branch once W895 lands.
- Variant A: `[611][2]^6 Pt` (~1.194 MiBit).

---

## feat(igla): Wave Loop 894 close-out — [607][2]^6 Pt packed AoS witness (Refs #1851)

- Branch: `wave-loop-894`
- PR: #1852 (auto-merge enabled)

### Что легло
- `specs/scratch/w894_bench_module_607x2p6_aos_var_call_write.t27` (`[607][2]^6 Pt`, 38,848 elements, 1,243,136-bit packed vector, ~1.186 MiBit): module-scope non-power-of-two outer-dimension array-of-struct variable initialized from a function call, with indexed signed field writes and `assert_eq` read-back in a `bench` block.
- Generator `scripts/gen_w894.py` copied from `gen_w893.py`, copy-hazard checklist cleared (`OUTER = 607`, `MID_IDX = 303`).
- Integration test `accepts_w894_bench_module_607x2p6_aos_var_call_write` added to `bootstrap/tests/icarus_lowerable.rs`.
- Fresh seal `.trinity/seals/scratch_w894_bench_module_607x2p6_aos_var_call_write.json` (`seal --verify` MATCH).
- Zero compiler / reference-model / `FROZEN_HASH` changes.
...
- `t27c icarus-cocotb` → reference-model OK
- `t27c seal --save` → saved
- Targeted `cargo test --release --test icarus_lowerable accepts_w894_bench_module_607x2p6_aos_var_call_write` → PASS
- Full suite: 353 passed; 1 pre-existing `corpus_classifier_matches_lean_completeness` mismatch for `specs/cloud/railway_deploy.t27` tracked separately.

### Next
- Create W895 issue and branch once W894 lands.
- Variant A: `[609][2]^6 Pt` (~1.190 MiBit).

---

## feat(igla): Wave Loop 893 close-out — [605][2]^6 Pt packed AoS witness (Refs #1848)

- Branch: `wave-loop-893`
- PR: #1850 (auto-merge enabled)

### Что легло
- `specs/scratch/w893_bench_module_605x2p6_aos_var_call_write.t27` (`[605][2]^6 Pt`, 38,720 elements, 1,239,040-bit packed vector, ~1.182 MiBit): module-scope non-power-of-two outer-dimension array-of-struct variable initialized from a function call, with indexed signed field writes and `assert_eq` read-back in a `bench` block.
- Generator `scripts/gen_w893.py` copied from `gen_w892.py`, copy-hazard checklist cleared (`OUTER = 605`, `MID_IDX = 302`).
- Integration test `accepts_w893_bench_module_605x2p6_aos_var_call_write` added to `bootstrap/tests/icarus_lowerable.rs`.
- Fresh seal `.trinity/seals/scratch_w893_bench_module_605x2p6_aos_var_call_write.json` (`seal --verify` MATCH).
- Zero compiler / reference-model / `FROZEN_HASH` changes.
...
- `t27c icarus-cocotb` → reference-model OK
- `t27c seal --save` → saved
- Targeted `cargo test --release --test icarus_lowerable accepts_w893_bench_module_605x2p6_aos_var_call_write` → PASS
- Full suite: 352 passed; 1 pre-existing `corpus_classifier_matches_lean_completeness` mismatch for `specs/cloud/railway_deploy.t27` tracked separately.

### Next
- Create W894 issue and branch once W893 lands.
- Variant A: `[607][2]^6 Pt` (~1.186 MiBit).

---

## feat(igla): Wave Loop 892 close-out — [603][2]^6 Pt packed AoS witness (Refs #1845)

- Branch: `wave-loop-892`
- PR: #1847 (auto-merge enabled)

### Что легло
- `specs/scratch/w892_bench_module_603x2p6_aos_var_call_write.t27` (`[603][2]^6 Pt`, 38,592 elements, 1,234,944-bit packed vector, ~1.178 MiBit): module-scope non-power-of-two outer-dimension array-of-struct variable initialized from a function call, with indexed signed field writes and `assert_eq` read-back in a `bench` block.
- Generator `scripts/gen_w892.py` copied from `gen_w891.py`, copy-hazard checklist cleared (`OUTER = 603`, `MID_IDX = 301`).
- Integration test `accepts_w892_bench_module_603x2p6_aos_var_call_write` added to `bootstrap/tests/icarus_lowerable.rs`.
- Fresh seal `.trinity/seals/scratch_w892_bench_module_603x2p6_aos_var_call_write.json` (`seal --verify` MATCH).
- Zero compiler / reference-model / `FROZEN_HASH` changes.
...
- `t27c icarus-cocotb` → reference-model OK
- `t27c seal --save` → saved
- Targeted `cargo test --release --test icarus_lowerable accepts_w892_bench_module_603x2p6_aos_var_call_write` → PASS
- Full suite: 351 passed; 1 pre-existing `corpus_classifier_matches_lean_completeness` mismatch for `specs/cloud/railway_deploy.t27` tracked separately.

### Next
- Create W893 issue and branch once W892 lands.
- Variant A: `[605][2]^6 Pt` (~1.182 MiBit).
...
- PR: #1842 (auto-merge enabled)

### Что легло
- `specs/scratch/w890_bench_module_599x2p6_aos_var_call_write.t27` (`[599][2]^6 Pt`, 38,336 elements, 1,226,752-bit packed vector, ~1.170 MiBit): module-scope non-power-of-two outer-dimension array-of-struct variable initialized from a function call, with indexed signed field writes and `assert_eq` read-back in a `bench` block.
- Generator `scripts/gen_w890.py` copied from `gen_w889.py`, copy-hazard checklist cleared (`OUTER = 599`, `MID_IDX = 299`).
- Integration test `accepts_w890_bench_module_599x2p6_aos_var_call_write` added to `bootstrap/tests/icarus_lowerable.rs`.
- Fresh seal `.trinity/seals/scratch_w890_bench_module_599x2p6_aos_var_call_write.json` (`seal --verify` MATCH).
- Zero compiler / reference-model / `FROZEN_HASH` changes.
...
- `t27c icarus-cocotb` → reference-model OK
- `t27c seal --save` → saved
- Targeted `cargo test --release --test icarus_lowerable accepts_w890_bench_module_599x2p6_aos_var_call_write` → PASS
- Full suite: 349 passed; 1 pre-existing `corpus_classifier_matches_lean_completeness` mismatch for `specs/cloud/railway_deploy.t27` tracked separately.

### Next
- Create W891 issue and branch once W890 lands.
- Variant A: `[601][2]^6 Pt` (~1.174 MiBit).
